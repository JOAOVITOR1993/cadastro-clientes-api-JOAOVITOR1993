...
const updateClientService = (idClient, clientData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const client = clientRepository.create(Object.assign(Object.assign({}, oldClientData), clientData));
